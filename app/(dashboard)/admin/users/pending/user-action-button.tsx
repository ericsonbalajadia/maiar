        ...
        >
          ...
          <form action={rejectAction} className="px-5 py-4 space-y-3">
            <Textarea
              ...
              className="min-h-[90px] resize-none bg-white/60 dark:bg-white/[0.05] border-slate-200 dark:border-slate-700 focus:border-rose-400 focus:ring-2 focus:ring-rose-400/20 transition-all text-sm placeholder:text-slate-400"
            />
            {rejectState.error && (
