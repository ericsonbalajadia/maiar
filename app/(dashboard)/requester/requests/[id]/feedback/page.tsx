...
if (!canSubmit) {
    ...
    return (
        <div className="max-w-2xl mx-auto p-6">
            <div className="rounded-lg border border-[#ADEBB3]/70 bg-amber-50 p-6 text-center space-y-4">
                ...
                <Link href={`/requester/requests/${id}`}>
                    <button className="px-4 py-2 bg-amber-600 text-white rounded-lg hover:bg-[#ADEBB3]/35 transition-colors">
                        Return to Request
                    </button>
                </Link>
            </div>
