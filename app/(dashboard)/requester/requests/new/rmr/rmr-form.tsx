            ...
            <div className="flex flex-col items-center gap-1.5">
              ...
              <span
                className={cn(
                  ...
                  isCurrent || isPast
                    ? "text-[#527255] dark:text-emerald-300"
...
export function RmrForm({ categories, dbUser }: RmrFormProps) {
  ...
  const validateStep = (s: number): boolean => {
    ...
    if (s === 3 && !form.title.trim()) errs.title = "Required";
    setErrors(errs);
              ...
              {categories.map((cat) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "group flex min-h-[58px] items-center gap-3 rounded-xl border px-3.5 py-3 text-left transition-colors duration-150 whitespace-normal text-wrap",
                      checked
