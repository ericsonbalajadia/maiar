  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="flex items-start justify-between">
        ...
        <Button asChild className="bg-slate-900 hover:bg-slate-800 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100 gap-2">
          <Link href="/requester/requests/new">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100 dark:border-slate-800">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button asChild variant="ghost" size="sm" className="text-xs text-blue-600 dark:text-blue-400 hover:text-blue-700 h-8">
