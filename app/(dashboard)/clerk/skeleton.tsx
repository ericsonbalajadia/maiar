    ...
    <div className="space-y-6 max-w-7xl mx-auto fade-in px-4 md:px-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        <div className="space-y-2">
          <div className="h-3 w-28 bg-slate-200 dark:bg-white/[0.08] rounded-full animate-pulse" />
          <div className="h-7 w-48 bg-slate-200 dark:bg-white/[0.08] rounded-lg animate-pulse" />
          <div className="h-4 w-64 bg-slate-100 dark:bg-white/[0.05] rounded-full animate-pulse" />
        </div>
        <div className="h-9 w-36 bg-slate-200 dark:bg-white/[0.08] rounded-xl animate-pulse" />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div>
                ...
                <div className="p-4 space-y-2">
                  <div className="flex items-start justify-between">
                    <div className="space-y-1">
                      <div className="h-4 w-32 bg-slate-200 dark:bg-white/[0.08] rounded-full" />
                      <div className="h-3 w-24 bg-slate-100 dark:bg-white/[0.05] rounded-full" />
                    </div>
                    <div className="h-5 w-16 bg-slate-200 dark:bg-white/[0.08] rounded-full" />
                  </div>
                  <div className="h-3 w-full bg-slate-100 dark:bg-white/[0.05] rounded-full" />
          ...
          <div className="mt-4 flex justify-center">
            <div className="h-5 w-36 bg-slate-200 dark:bg-white/[0.08] rounded-full animate-pulse" />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-4 flex justify-center">
            <div className="h-5 w-44 bg-slate-200 dark:bg-white/[0.08] rounded-full animate-pulse" />
          </div>
        </div>
      </div>
    </div>
