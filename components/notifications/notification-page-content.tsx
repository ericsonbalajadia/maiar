          ...
          <div className="flex items-center gap-3 mt-2.5 flex-wrap">
            ...
            {isUnread && (
              <button
                ...
                className="text-[11px] font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-700 transition-colors ml-auto"
              >
                Mark as read
              </button>
            )}
...
export function NotificationsPageContent() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 fade-in">
      ...
      <div
        className="flex items-center gap-1 p-1 rounded-xl border border-slate-200/60 dark:border-slate-700/60 w-fit"
        ...
        {FILTER_OPTIONS.map(({ value, label }) => (
          ...
          >
            ...
            {value === "unread" && unreadCount > 0 && (
              <span className="ml-1.5 text-[10px] font-bold bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-300 px-1.5 py-px rounded-full">
                {unreadCount}
              </span>
            )}
          </button>
      ...
      {loading ? (
        <div className="space-y-3">
          {[...Array(5)].map((_, i) => (
            <div
              key={i}
              className="rounded-xl border border-slate-100 dark:border-slate-800 p-4 flex gap-3 bg-white/60 dark:bg-slate-900/40"
            >
        ...
        <div
          className="rounded-2xl border border-slate-200/60 dark:border-slate-700/60 flex flex-col items-center justify-center py-16 text-center"
          style={{
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between pt-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-medium text-slate-600 dark:text-slate-400 min-w-[60px] text-center">
              {page} / {totalPages}
            </span>
            <Button
              variant="outline"
